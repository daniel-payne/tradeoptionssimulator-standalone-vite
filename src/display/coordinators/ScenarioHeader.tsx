...
export default function ScenarioHeader({ scenario, name = "TradingHeader", ...rest }: PropsWithChildren<ComponentProps>) {
  ...
  return (
    <div {...rest} data-controller={name}>
      <div className="w-full flex flex-row gap-2 justify-between items-center bg-base-200 p-2">
        <ApplicationNavigation title={scenario.name} parentTitle="Scenarios" parentLink="/scenarios" />
