...
export default function HistoryHeader({ name = "HistoryHeader", ...rest }: PropsWithChildren<ComponentProps>) {
  ...
  return (
    <div {...rest} data-controller={name}>
      <div className="w-full flex flex-row gap-2 justify-between items-center bg-base-200 p-2">
        <ApplicationNavigation title="Trading History" />
        <div className="flex flex-row gap2 justify-center items-center">{/* <RangeChooser /> */}</div>
