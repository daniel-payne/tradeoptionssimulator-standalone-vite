...
export type Height = "full" | "auto" | "1/2" | "1/3" | "1/4" | "1/5" | "1/6" | "24" | "32" | "40" | "48" | "64" | "80" | "96"
...
export default function WidthChooser({ name = "HeightChooser", ...rest }: PropsWithChildren<ComponentProps>) {
  const [view, setView] = useQueryState<Height>("height", "auto")

  const handleClick = (range: Height) => {
  ...
  const handleClick32 = handleClick("32")
  ...
  let className32 = UNSELECTED_BUTTON
  ...
  return (
    <div {...rest} data-component={name}>
      <div className="flex flex-row gap-2 justify-center items-center">
        ...
        <div className={className32} onClick={handleClick32}>
          32
        </div>
